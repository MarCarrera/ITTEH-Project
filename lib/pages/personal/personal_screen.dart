...
//--------------------------------------COMIENZA CUERPO DE LA CATEGORIA PERSONAL-----------------------------//
      body: ListView(
    ...
    return Row(
      ...
      children: [
        ...
        Container(
            height: 50.0,
            width: 50.0,
            margin: const EdgeInsets.only(left: 13.0, bottom: kDefaultPaddin),
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0), color: cSearchBar),
